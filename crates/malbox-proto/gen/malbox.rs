...
pub struct CertsRequest {
    #[prost(string, tag = "1")]
    pub server_cert_pem: ::prost::alloc::string::String,
    #[prost(string, tag = "2")]
    pub server_key_pem: ::prost::alloc::string::String,
    #[prost(string, tag = "3")]
...
pub mod bootstrap_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn provide_certs(
            &mut self,
            request: impl tonic::IntoRequest<super::CertsRequest>,
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/malbox.Bootstrap/ProvideCerts",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("malbox.Bootstrap", "ProvideCerts"));
...
pub mod bootstrap_server {
    ...
    pub trait Bootstrap: std::marker::Send + std::marker::Sync + 'static {
        async fn provide_certs(
            &self,
            request: tonic::Request<super::CertsRequest>,
        ) -> std::result::Result<tonic::Response<super::Ack>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/malbox.Bootstrap/ProvideCerts" => {
                    ...
                    struct ProvideCertsSvc<T: Bootstrap>(pub Arc<T>);
                    impl<T: Bootstrap> tonic::server::UnaryService<super::CertsRequest>
                    for ProvideCertsSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as Bootstrap>::provide_certs(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let fut = async move {
                        let method = ProvideCertsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
